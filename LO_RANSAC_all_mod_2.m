function [ number_inliers_best, RunTime, k, inlier_ratio_best,residual_output_best] = LO_RANSAC_all_2(pts, pts_tilde, threshold,dd,outlier_ratio)
...
t_new_best = t_best;
  ...
  % Start the Local Optimization process after 30 iterations of RANSAC
